 ...
 */
public class ScannedNumberRank extends Rank implements ReusableRank {
     ...
     */
    private static ArrayList<Double> scoreLeaderboard;
     ...
     */
    public ScannedNumberRank(String identifier, double value){
