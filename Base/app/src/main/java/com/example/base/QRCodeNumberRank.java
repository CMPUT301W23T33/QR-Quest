 ...
 */
public class QRCodeNumberRank extends Rank implements ReusableRank {
     ...
     */
    public QRCodeNumberRank(String identifier, double value, double queryValue) {
